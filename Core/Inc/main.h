...
#define SPINDLE_ENCA0_Pin GPIO_PIN_0
#define SPINDLE_ENCA0_GPIO_Port GPIOA
...
#define PANEL_ENC_B_Pin GPIO_PIN_12
#define PANEL_ENC_B_GPIO_Port GPIOD
#define PANEL_ENC_A_Pin GPIO_PIN_13
#define PANEL_ENC_A_GPIO_Port GPIOD
...
#define LONGITUDIAL_FEED_PULSE_Pin GPIO_PIN_15
#define LONGITUDIAL_FEED_PULSE_GPIO_Port GPIOA
#define SWITCH_GAP_COMPENSATION_Pin GPIO_PIN_0
#define SWITCH_GAP_COMPENSATION_GPIO_Port GPIOD
